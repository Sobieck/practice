...
module Problem0022Tests = 
    ...
    type Problem0022() = 
        ...
        member x.``Problem0022 parseAndAlphabetizeNames testNames returns correctList.``() =
            Assert.AreEqual(["ABA";"BAB";"DRAT";"ZA"], parseAndAlphabetizeNames "C:\Users\Thomas\Documents\GitHub\haskell.practice\PE\problemSpaces\p022_test.txt")

        [<TestMethod>]
        member x.``Problem0022 scoreListSum testNames returns 251.``() =
            Assert.AreEqual(251, scoreListSum "C:\Users\Thomas\Documents\GitHub\haskell.practice\PE\problemSpaces\p022_test.txt")

        [<TestMethod>]
        member x.``Problem0022 answer.``() =
            Assert.AreEqual(871198282, scoreListSum "C:\Users\Thomas\Documents\GitHub\haskell.practice\PE\problemSpaces\p022_names.txt")