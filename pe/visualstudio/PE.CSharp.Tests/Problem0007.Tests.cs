...
namespace PE.CSharp.Tests
{
    ...
    public class Problem0007Tests
    {
        ...
        [TestMethod]
        public void Problem0007_NthPrime_1_Should_Return_2()
        {
            Assert.AreEqual(2, _problem0007.NthPrime(1));
        }

        [TestMethod]
        public void Problem0007_NthPrime_6_Should_Return_13()
        {
            Assert.AreEqual(13, _problem0007.NthPrime(6));
        }

        [TestMethod]
        public void Problem0007_NthPrime_4_Should_Return_7()
        {
            Assert.AreEqual(7, _problem0007.NthPrime(4));
        }

        [TestMethod]
        public void Problem0007_NthPrime_10001_Should_Return_104743()
        {
